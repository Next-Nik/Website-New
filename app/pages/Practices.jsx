      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button type="button" onClick={() => setExpanded(v => !v)}
            style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em', color: '#A8721A', background: 'transparent', border: '1px solid rgba(200,146,42,0.30)', borderRadius: '40px', padding: '6px 14px', cursor: 'pointer' }}>
...
function EmptyState({ filtersActive, isSignedIn }) {
  ...
  return (
    <div style={{
      ...
      <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.2em', color: '#A8721A', textTransform: 'uppercase', display: 'block', marginBottom: '14px' }}>
        Empty by design
      </span>
      <p style={{
        ...garamond,
