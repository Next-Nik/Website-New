...
function ResolverNote({ claimId, onResolve }) {
  ...
  return (
    <div style={{ marginTop: '16px' }}>
      <div style={{ fontFamily: "'Cormorant SC', Georgia, serif", fontSize: '13px', letterSpacing: '0.16em', color: '#A8721A', textTransform: 'uppercase', marginBottom: '6px' }}>
      ...
      {(mode === 'add' || mode === 'edit') && (
        <div style={{ maxWidth: '640px' }}>
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            ...
            <div>
              <label style={{ ...sc, fontSize: '13px', letterSpacing: '0.16em', color: gold, display: 'block', marginBottom: '5px' }}>Alignment score (0-9)</label>
        ...
        <Card key={row.id}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {editing === row.id && (
                <div style={{ marginTop: '14px', paddingTop: '14px', borderTop: '1px solid rgba(200,146,42,0.20)' }}>
                  <IndicatorForm form={form} setForm={setForm} />
                  <div style={{ display: 'flex', gap: '8px', marginTop: '14px' }}>
                    <Btn small onClick={save}>Save</Btn>
...
function IndicatorForm({ form, setForm }) {
  ...
  const fieldInput = { ...body, fontSize: '13px', color: '#0F1523', padding: '8px 12px', borderRadius: '6px', border: '1px solid rgba(200,146,42,0.30)', background: '#FFFFFF', outline: 'none', width: '100%', boxSizing: 'border-box' }
  return (
    <div style={{ display: 'grid', gap: '12px' }}>
      ...
      <div style={{ paddingTop: '8px', borderTop: '1px dashed rgba(200,146,42,0.20)' }}>
    ...
    <div>
      ...
      {selectedId && rows.length > 0 && (
        <div>
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid rgba(200,146,42,0.20)', borderRadius: '14px', overflow: 'hidden' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr 140px 140px 80px', padding: '10px 14px', borderBottom: '1px solid rgba(200,146,42,0.20)', background: 'rgba(200,146,42,0.04)', ...sc, fontSize: '13px', letterSpacing: '0.14em', color: gold, fontWeight: 600 }}>
              <div>OBSERVED</div>
              <div>VALUE</div>
              <div>FETCHED</div>
              <div>CONFIDENCE</div>
            ...
            {rows.map(r => (
              <div key={r.id} style={{ display: 'grid', gridTemplateColumns: '140px 1fr 140px 140px 80px', padding: '10px 14px', borderBottom: '1px solid rgba(200,146,42,0.10)', ...body, fontSize: '13px', color: '#0F1523' }}>
...
function IndicatorCronLogView({ toast }) {
  ...
  const statusColour = {
    ...
    'not-implemented': 'rgba(168, 114, 26, 0.85)',
  }
  ...
  return (
    <div>
      ...
      {!loading && rows.length > 0 && (
        <div style={{ background: '#FFFFFF', border: '1px solid rgba(200,146,42,0.20)', borderRadius: '14px', overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '160px 100px 1fr 80px 80px', padding: '10px 14px', borderBottom: '1px solid rgba(200,146,42,0.20)', background: 'rgba(200,146,42,0.04)', ...sc, fontSize: '13px', letterSpacing: '0.14em', color: gold, fontWeight: 600 }}>
            <div>RUN AT</div>
            <div>STATUS</div>
          ...
          {rows.map(r => {
            ...
            return (
              <div key={r.id} style={{ display: 'grid', gridTemplateColumns: '160px 100px 1fr 80px 80px', padding: '10px 14px', borderBottom: '1px solid rgba(200,146,42,0.10)', ...body, fontSize: '13px', color: '#0F1523' }}>
