      ...
      <div className="nominate-main" style={{ maxWidth: '600px', margin: '0 auto', padding: '80px 40px 120px' }}>
        ...
        <form onSubmit={submit}>
          ...
          <Field>
            ...
            {selectedGoal && (
              <div style={{
                ...
                <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em', color: 'rgba(15,21,35,0.55)', marginBottom: '4px' }}>
                  HORIZON GOAL
                </div>
          ...
          <div style={{ paddingTop: '24px', borderTop: '1px solid rgba(200,146,42,0.18)', marginTop: '8px' }}>
            <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: 'rgba(15,21,35,0.55)', textTransform: 'uppercase', marginBottom: '20px' }}>
              Your details
            </div>
