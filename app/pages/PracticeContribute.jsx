// src/beta/pages/PracticeContribute.jsx
//
...
function Eyebrow({ children, style = {} }) {
  return (
    <span style={{
      ...sc, fontSize: '13px', letterSpacing: '0.18em', color: '#A8721A',
...
export default function PracticeContribute() {
        ...
        <form onSubmit={handleProceed}>
          ...
          <FieldGroup>
            ...
            <button type="button"
              ...
              style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em', color: '#A8721A', background: 'transparent', border: 'none', cursor: 'pointer', padding: 0, marginTop: '4px' }}>
              + Add another chain
            </button>
          </FieldGroup>
