// ─────────────────────────────────────────────────────────────
// Map — geographic actor map (Module 5)
//
    ...
    <div style={{
      ...
      <div style={{ padding: '8px 22px 32px', flex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '14px', flexWrap: 'wrap' }}>
          {actor.type && (
            <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.12em', color: 'rgba(15,21,35,0.55)' }}>{actor.type}</span>
          )}
          {actor.scale && (
        ...
        {(subdomains.length > 0 || fields.length > 0 || lenses.length > 0 || problems.length > 0) && (
          <div style={{ borderTop: `1px solid rgba(200,146,42,0.12)`, paddingTop: '14px', marginBottom: '16px' }}>
            <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: 'rgba(15,21,35,0.55)', marginBottom: '10px' }}>
              Placement
            </div>
            ...
            {problems.length > 0 && (
              <div style={{ marginBottom: '10px' }}>
                <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.13em', color: 'rgba(15,21,35,0.55)', marginBottom: '5px' }}>Problem</div>
        ...
        {principles.length > 0 && (
          <div style={{ marginBottom: '16px' }}>
            <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: 'rgba(15,21,35,0.55)', marginBottom: '7px' }}>
              Principles
            </div>
...
function PlacementRow({ label, items, color }) {
  return (
    <div style={{ marginBottom: '10px' }}>
      <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.13em', color: 'rgba(15,21,35,0.55)', marginBottom: '5px' }}>{label}</div>
      <div style={{ display: 'flex', gap: '4px', flexWrap: 'wrap' }}>
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.12em', color: 'rgba(15,21,35,0.55)' }}>
    ...
    mappedActors.forEach(actor => {
      ...
      marker.bindTooltip(
        `<div style="font-family:'Lora',serif;font-size:13px;font-weight:300;color:#0F1523">${actor.name}</div>
         <div style="font-family:'Cormorant SC',serif;font-size: 13px;letter-spacing:0.1em;color:rgba(15,21,35,0.55);margin-top:2px">${DOMAIN_LABEL[prim] || ''}${extras}${actor.scale ? ' · ' + (SCALE_LABEL[actor.scale] || actor.scale) : ''}</div>`,
          ...
          <div style={{ marginBottom: '10px' }}>
            <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap', alignItems: 'center' }}>
                ...
                return (
                  <div key={domain} style={{ display: 'flex', alignItems: 'stretch' }}>
                    ...
                    >
                      ...
                      <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.13em', color: isOn ? dark : 'rgba(15,21,35,0.55)' }}>
                        {DOMAIN_LABEL[domain]}
                      </span>
                    </button>
                    {isOn && (
              ...
              <button
                ...
                style={{ ...sc, fontSize: '13px', letterSpacing: '0.12em', color: 'rgba(15,21,35,0.55)', background: 'none', border: 'none', cursor: 'pointer', padding: '4px' }}
              >
                All
              </button>
              <button
          ...
          {focusDomain && subdomainOptions.length > 0 && (
            <div style={{
              ...
              <button
                ...
                style={{ ...sc, fontSize: '13px', color: 'rgba(15,21,35,0.55)', background: 'none', border: 'none', cursor: 'pointer', marginLeft: '4px' }}
              >
                Clear ×
              </button>
            </div>
        ...
        <div className="beta-map-container" style={{ maxWidth: '1100px', margin: '0 auto', width: '100%', padding: '0 32px 20px' }}>
          <div style={{ position: 'relative', borderRadius: '14px', overflow: 'hidden', border: `1.5px solid rgba(200,146,42,0.22)`, background: '#E8E4DC' }}>
            ...
            <div className="beta-map-scale-legend" style={{ position: 'absolute', bottom: '32px', right: '10px', background: 'rgba(250,250,247,0.94)', border: `1px solid rgba(200,146,42,0.20)`, borderRadius: '8px', padding: '10px 13px', zIndex: 700, minWidth: '160px' }}>
              <div style={{ ...sc, fontSize: '13px', letterSpacing: '0.16em', color: 'rgba(15,21,35,0.55)', marginBottom: '7px' }}>
              ...
              {SCALE_ORDER.map(s => {
                ...
                return (
                  <div key={s} style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px', opacity: visible ? 1 : 0.30 }}>
                    ...
                    <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.10em', color: visible ? dark : 'rgba(15,21,35,0.55)' }}>
                      {SCALE_LABEL[s] || s}
                    </span>
                  </div>
                )
              ...
              return (
                <div key={domain} style={{ marginBottom: '28px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                    ...
                    <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.17em', color: 'rgba(15,21,35,0.55)' }}>
