// src/beta/pages/PracticeDetail.jsx
//
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: '12px', marginBottom: '6px', flexWrap: 'wrap' }}>
        <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.1em', color: '#A8721A', fontWeight: 600 }}>
          {display}
        </span>
...
function SectionHeading({ children, count }) {
  return (
    <div style={{
      ...
      <h2 style={{ ...sc, fontSize: '13px', letterSpacing: '0.2em', color: '#A8721A', textTransform: 'uppercase', margin: 0, fontWeight: 600 }}>
        {children}
      </h2>
      {typeof count === 'number' && (
