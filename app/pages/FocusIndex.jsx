      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          {selectedDomains.size > 0 && (
            <div style={{ ...body, fontSize: '13px', color: 'rgba(15,21,35,0.55)' marginTop: '8px' }}>
  ...
  return (
    <div style={{
      ...
      <Link
        ...
        style={{ ...sc, fontSize: '13px', letterSpacing: '0.10em', color: gold, textDecoration: 'none', padding: '0 4px', borderLeft: '1px solid rgba(200,146,42,0.20)' }}
      >
        OPEN
      </Link>
    </div>
