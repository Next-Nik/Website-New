      ...
      <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', padding: '0 24px' }}>
        {SELF_DOMAINS.map(d => (
          <div key={d.key} style={{ borderLeft: `3px solid ${d.hex}`, paddingLeft: 16, marginBottom: 32 }}>
            ...
            <p style={{ fontFamily: SC, fontSize: 13, letterSpacing: '0.14em', color: 'rgba(15,21,35,0.5)', textTransform: 'uppercase', margin: '0 0 10px' }}>Where are you right now?</p>
            <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
              ...
              <div style={{ minWidth: 82 }}>
                <div style={{ fontFamily: SC, fontSize: 24, fontWeight: 600, color: d.hex, lineHeight: 1 }}>
                  {scores[d.key] ?? 5}<span style={{ fontFamily: SC, fontSize: 13, color: 'rgba(15,21,35,0.5)', letterSpacing: '0.1em' }}> *</span>
                </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
              <span style={{ fontFamily: LORA, fontSize: 13, color: 'rgba(15,21,35,0.45)' }}>Zero</span>
              <span style={{ fontFamily: LORA, fontSize: 13, color: 'rgba(15,21,35,0.45)' }}>The best there is</span>
            </div>
          </div>
        ))}
        <div style={{ height: 24 }} />
