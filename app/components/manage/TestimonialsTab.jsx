...
function TestimonialRow({ testimonial, onSave, onDelete, toast }) {
  ...
  if (!editing) {
    return (
      <div style={{ borderLeft: testimonial.featured
          ? '2px solid rgba(76,107,69,0.60)'
          : '2px solid rgba(76,107,69,0.20)',
        ...
        <div style={{ display: 'flex', gap: '8px',
          ...
          <button onClick={() => setEditing(true)}
            style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em',
              ...
              border: '1px solid rgba(76,107,69,0.30)',
              background: 'rgba(76,107,69,0.04)', color: gold }}>
            Edit
          </button>
  ...
  return (
    <div style={{ background: 'rgba(76,107,69,0.03)',
      border: '1px solid rgba(76,107,69,0.20)', borderRadius: '10px',
    ...
    return (
      <button onClick={() => setOpen(true)}
        style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em',
          ...
          border: '1px dashed rgba(76,107,69,0.45)',
          background: 'rgba(76,107,69,0.04)', color: gold,
          marginTop: '8px' }}>
        + Add testimonial
      </button>
