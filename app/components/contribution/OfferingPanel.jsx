    ...
    <div style={{ marginBottom: '24px' }}>
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: '12px', marginBottom: '6px' }}>
        ...
        <span style={{
          ...
          fontSize: '13px',
          letterSpacing: '0.1em',
          color: saving ? '#262420' : savedRecently ? '#2D6A4F' : 'rgba(15,21,35,0.55)',
      ...
      {options.map(o => (
        <button
          ...
          style={{
            ...
            color: value === o.v ? '#262420' : 'rgba(15,21,35,0.72)',
            background: value === o.v ? 'rgba(76,107,69,0.08)' : '#FFFFFF',
            border: value === o.v
              ? '1px solid rgba(76,107,69,0.55)'
              : '1px solid rgba(76,107,69,0.25)',
            borderRadius: '40px',
            padding: '6px 14px',
            cursor: 'pointer',
...
function PrincipleRow({ principle, selected, weight, onToggle, onWeightChange }) {
  return (
    <div style={{
      padding: '12px 14px',
      background: selected ? 'rgba(76,107,69,0.04)' : '#FFFFFF',
      border: selected
        ? '1px solid rgba(76,107,69,0.40)'
        ...
        return (
          <button
            ...
            style={{
              ...
              fontSize: '13px',
              letterSpacing: '0.04em',
              color: active ? (d.color || '#262420') : 'rgba(15,21,35,0.72)',
              background: active ? 'rgba(76,107,69,0.08)' : '#FFFFFF',
              border: active
                ? `1px solid ${d.color || '#262420'}`
                : '1px solid rgba(76,107,69,0.25)',
              borderRadius: '40px',
              padding: '5px 12px',
              cursor: 'pointer',
            ...
            onMouseEnter={(e) => {
              if (!active) e.currentTarget.style.background = 'rgba(76,107,69,0.04)'
            }}
            onMouseLeave={(e) => {
