  ...
  if (selected) {
    return (
      <div style={{
        ...
        padding: '10px 14px', background: 'rgba(38,36,32,0.06)',
        border: '1px solid rgba(76,107,69,0.30)', borderRadius: '8px',
      }}>
        <div>
    ...
    <div>
      ...
      {results.length > 0 && (
        <div style={{
          ...
          border: '1px solid rgba(76,107,69,0.22)', borderRadius: '8px',
          ...
          {results.map(v => (
            <button
              ...
              style={{
                ...
                border: 'none', borderBottom: '1px solid rgba(76,107,69,0.10)',
          ...
          {filtered.map(t => (
            <button
              ...
              style={{
                ...
                border: 'none', borderBottom: '1px solid rgba(76,107,69,0.08)',
                cursor: 'pointer', fontFamily: body.fontFamily, fontSize: '14px',
                color: dark,
              }}
            >
          ...
          return (
            <button
              ...
              style={{
                ...
                border: on
                  ? (isPrimary ? '2px solid rgba(76,107,69,0.78)' : '1.5px solid rgba(76,107,69,0.40)')
                  : '1.5px solid rgba(76,107,69,0.25)',
                background: on ? 'rgba(76,107,69,0.10)' : 'transparent',
                color: on ? gold : (isActorDomain ? 'rgba(38,36,32,0.62)' : 'rgba(15,21,35,0.55)'),
                position: 'relative',
              }}
            >
              {d.label}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: p.is_primary ? '1.5px solid rgba(76,107,69,0.78)' : '1.5px solid rgba(76,107,69,0.25)',
                    background: p.is_primary ? 'rgba(76,107,69,0.14)' : 'transparent',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{
        ...
        paddingTop: '16px', borderTop: '1px solid rgba(76,107,69,0.20)',
      }}>
