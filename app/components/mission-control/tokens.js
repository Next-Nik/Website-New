...
// Colour — Civ stage (the dark instrument frames on Mission Control).
// PINNED to dark-stage literals so they stay correct after the Atlas
// palette (`at`) was flipped bright in the retheme: these render on the
// deep-navy instrument ground (BG_INK), so they must remain white/soft-dark
// regardless of what `at.*` now resolves to. Sourced from the wheel's
// slate/navy family, matching BG_INK.
export const BG_INK_SOFT      = '#1B2740'
export const TEXT_WHITE       = '#FFFFFF'
export const TEXT_WHITE_META  = 'rgba(255,255,255,0.66)'
export const TEXT_WHITE_FAINT = 'rgba(255,255,255,0.58)'
