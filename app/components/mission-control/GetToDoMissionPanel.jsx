...
function Row({ item, done, reorder, first, last, tag, onToggle, onStar, onSetDate, onUp, onDown, onRemove }) {
  ...
  return (
    <div style={{
      ...
      background: isDone ? 'rgba(76,107,69,0.05)' : 'transparent',
    }}>
      {/* Checkbox */}
...
function ConsistencyLine({ streak, onToggle }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: '8px', background: 'rgba(76,107,69,0.05)',
    }}>
        ...
        <div>
          {calEvents.map((evt, i) => (
            <div key={evt.id || i} style={{
              ...
              borderLeft: `3px solid ${GOLD_RULE}`, background: 'rgba(76,107,69,0.04)',
            }}>
              {evt.time_label && (
