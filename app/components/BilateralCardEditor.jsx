  ...
  return (
    <input
      ...
      style={{
        ...
        background: disabled ? 'rgba(76,107,69,0.03)' : '#FFFFFF',
    ...
    <div style={{ position: 'relative' }}>
      ...
      {(results.length > 0 || searching) && (
        <div style={{
          ...
          background: '#FFFFFF', border: '1.5px solid rgba(76,107,69,0.30)',
          ...
          {results.map(r => (
            <button
              ...
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(76,107,69,0.04)'}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: on ? '1.5px solid rgba(76,107,69,0.78)' : '1.5px solid rgba(76,107,69,0.20)',
                  background: on ? 'rgba(76,107,69,0.08)' : '#FAFAF7',
