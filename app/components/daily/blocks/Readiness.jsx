    ...
    <div>
      <style>{`
        @keyframes rd-pulse-yes {
          0%, 100% { box-shadow: 0 6px 16px rgba(38,36,32,0.28), 0 0 0 0 ${tokens.goldStrong}; }
          50%      { box-shadow: 0 6px 16px rgba(38,36,32,0.28), 0 0 0 18px transparent; }
        }
        ...
        .rd-yes:active {
          ...
          box-shadow: 0 2px 6px rgba(38,36,32,0.30), inset 0 3px 10px rgba(0,0,0,0.22);
          animation: none;
        }
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '22px' }}>
          <button
            ...
            style={{
              ...
              boxShadow: '0 6px 16px rgba(38,36,32,0.28)',
            }}
          >Yes</button>
        </div>
