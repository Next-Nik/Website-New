...
--     machine-written.
--
-- Numbering: renumbered from 181, which was claimed three times over (Care
-- Protocol, NextSteps phases, this). Pairs with 184_pulse_events. See the
-- tombstone left at 181.
--
