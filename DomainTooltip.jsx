...
export const NEXTUS_TIPS = {
  'human-being':     { tip: "Every person has what they need to know themselves, develop fully, and bring what they came here to bring.",              desc: "The full terrain of what it means to be human — individually and collectively. Health, education, consciousness, rights, culture." },
  'society':         { tip: "Humanity knows how to be human together — and every individual is better for it.",              desc: "How human beings organise collective life. Society is both a collective and a group of individuals. Neither overrides the other." },
  'nature':          { tip: "Ecosystems are thriving and we are living in harmony with the planet.",                                      desc: "The living systems of the planet. Humanity as participant in, not owner of, these systems." },
  'technology':      { tip: "Our creations support and amplify life.",            desc: "The tools that amplify or undermine human flourishing. The most powerful lever civilisation has — and the most dangerous." },
  'finance-economy': { tip: "Resources flow toward what sustains and generates life.",                                  desc: "How humanity creates, moves, and allocates the resources that sustain life. The economy is a design. It can be redesigned." },
  'legacy':          { tip: "We are ancestors worth having.",                             desc: "What we leave behind — the long arc of civilisational continuity, intergenerational responsibility, and the transmission of wisdom." },
  'vision':          { tip: "Into the unknown. On purpose. Together.",                                   desc: "Where humanity is going — the imaginative, philosophical, and spiritual capacity to see possibility and orient collective life toward it." },
}
...
export function DomainTooltip({ domainKey, label, system = 'lifeos', position = 'below' }) {
  ...
  return (
    <span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
      ...
      {show && (
        <span style={tipStyle}>
          <span style={{ ...sc, fontSize: '10px', letterSpacing: '0.14em', color: '#A8721A', display: 'block', marginBottom: '5px', textTransform: 'uppercase' }}>
            {label || domainKey}
          </span>
          <span style={{ ...sc, fontSize: '11px', letterSpacing: '0.06em', color: 'rgba(200,146,42,0.7)', display: 'block', marginBottom: '6px', fontWeight: 300 }}>
            {topLine}
          </span>
