              ...
              {!loading && glossary && !isFiltering && CATEGORIES.map(cat => {
                ...
                return (
                  <div key={cat.label} style={{ marginBottom: '20px' }}>
                    <div style={{ fontFamily: "'IBM Plex Mono', Georgia, serif", fontSize: '15px', letterSpacing: '0.18em', color: '#262420', textTransform: 'uppercase', marginBottom: '8px', padding: '0 8px' }}>
                      {cat.label}
                    </div>
...
function TermCard({ term }) {
  return (
    <div style={{
      ...
      <div style={{ fontFamily: "'IBM Plex Mono', Georgia, serif", fontSize: '15px', color: '#262420', marginBottom: '4px', lineHeight: 1.2 }}>
        {term.term}
      </div>
