...
const FLAME_SCALE = {
  ...
  9.5:  { color: '#6E7F5C', glow: 'rgba(76,107,69,0.76)', scale: 1.04, label: '' },
  10:   { color: '#6E7F5C', glow: 'rgba(76,107,69,0.82)', scale: 1.08, label: 'Best in the World' },
}
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              height: `${(value / 10) * 100}%`,
              background: 'linear-gradient(to top, #4B5563 0%, #8B7355 22%, #B8923A 42%, #6E7F5C 58%, #C8721A 73%, #262420 87%, #6E7F5C 100%)',
              borderRadius: '5px',
