...
//
// Component reuse:
//   IndicatorCard, IndicatorTable, ContributorSignalsList — all
//   imported as-is. Source of truth is in src/beta/components/.
// ─────────────────────────────────────────────────────────────
  ...
  return (
    <div style={{ padding: '4px 0' }}>
      ...
      <p style={{
        ...
        that domain, or values have not yet been collected.
      </p>
...
function DomainExpanded({ domain }) {
