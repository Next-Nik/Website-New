...
import { HomecomingPage }     from './pages/Homecoming'        /* hidden · founder only · own front door, entered from the Profile panel */
import { TimekeeperPage }     from './pages/Timekeeper'        /* hidden · founder only · own front door, entered from the Profile panel */
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/homecoming"      element={<HomecomingPage />} />      {/* hidden · founder gate in-page, RLS in sql/189 */}
        <Route path="/time"            element={<TimekeeperPage />} />      {/* hidden · founder gate in-page, RLS in sql/190 */}
