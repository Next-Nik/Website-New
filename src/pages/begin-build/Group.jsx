          ...
          <div style={{ paddingTop: '40px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <button onClick={() => navigate('/begin/build/practice')}
                style={{ ...SC, fontSize: '13px', letterSpacing: '0.14em', padding: '12px 24px', borderRadius: '40px', border: 'none', background: '#C8922A', color: '#FFFFFF', cursor: 'pointer' }}>
                Bring another person  →
              </button>
              <button onClick={() => { setForm(EMPTY); setDone(false) }}
                style={{ ...SC, fontSize: '13px', letterSpacing: '0.14em', padding: '12px 24px', borderRadius: '40px', border: '1.5px solid rgba(200,146,42,0.78)', background: 'rgba(200,146,42,0.05)', color: GOLD, cursor: 'pointer' }}>
