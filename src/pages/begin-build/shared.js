        ...
        <div key={i} style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
          ...
          {list.length > 1 && (
            <button
              type="button"
              onClick={() => remove(i)}
              style={{ ...SC, fontSize: '13px', letterSpacing: '0.10em', padding: '0 14px', borderRadius: '8px', border: '1px solid rgba(15,21,35,0.20)', background: 'transparent', color: 'rgba(15,21,35,0.55)', cursor: 'pointer' }}
            >
              Remove
            </button>
          )}
