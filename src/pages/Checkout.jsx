  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        border: '1.5px solid rgba(76,107,69,0.78)', borderRadius: '14px',
        padding: '48px 36px 40px', textAlign: 'center',
      }}>
        <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: '#262420', display: 'block', marginBottom: '16px' }}>
          Welcome
        </span>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {eyebrow && <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: '#262420', display: 'block', marginBottom: '12px' }}>{eyebrow}</span>}
