...
function Featured({ children, right = false }) {
  return (
    <div style={{
      ...
      <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: 'clamp(20px,2.6vw,26px)', fontWeight: 400, ...dark, lineHeight: 1.55, margin: 0 }}>
        {children}
      </p>
    </div>
  )
...
function ToolRow({ name, desc }) {
  return (
    <div style={{ display: 'flex', gap: '20px', padding: '16px 0', borderBottom: '1px solid rgba(200,146,42,0.05)', alignItems: 'baseline' }}>
      <span style={{ ...sc, fontSize: '15px', letterSpacing: '0.14em', ...gold, minWidth: '160px', flexShrink: 0 }}>{name}</span>
      <span style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '16px', ...meta, lineHeight: 1.6 }}>{desc}</span>
    </div>
  )
}
...
function Value({ name, desc }) {
  return (
    <div style={{ borderRight: '3px solid rgba(200,146,42,0.20)', padding: '14px 24px 14px 0', textAlign: 'right' }}>
      ...
      <p style={{ margin: 0, fontFamily: "'Lora', Georgia, serif", fontSize: '16px', ...meta }}>{desc}</p>
    </div>
  )
}
    ...
    <div style={{ background: '#FAFAF7', minHeight: '100vh' }}>
      ...
      <div className="about-section" style={page}>
        ...
        <div style={{ borderLeft: '3px solid #C8922A', padding: '18px 0 18px 28px', margin: '40px 0' }}>
          <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '16px', ...dark, lineHeight: 1.7, margin: 0 }}>
      ...
      <div className="about-section" style={pageRight}>
        ...
        <div style={{ marginBottom: '48px', padding: '28px 32px', background: 'rgba(200,146,42,0.05)', border: '1px solid rgba(200,146,42,0.18)', borderRadius: '14px', textAlign: 'left' }}>
          ...
          <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '16px', fontWeight: 300, ...dark, lineHeight: 1.8, margin: '0 0 8px', maxWidth: '520px' }}>
          ...
          <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '16px', fontWeight: 300, ...dark, lineHeight: 1.8, margin: '0 0 20px', maxWidth: '520px' }}>
