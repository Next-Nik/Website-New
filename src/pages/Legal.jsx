...
export function PrivacyPage() {
  return (
    <LegalWrap eyebrow="Privacy" title="How we handle<br><em style='color:#A8721A;'>your information.</span>" subtitle="Last updated March 2026 · NextUs / Nik Wood" active="">
      ...
      <P><em>Questions? <a href="mailto:hello@nextus.world" style={{ color: '#A8721A', textDecoration: 'none', borderBottom: '1px solid rgba(200,146,42,0.3)' }}>hello@nextus.world</a></span></P>
    </LegalWrap>
  )
}
