  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAFAF7', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '48px' }}>
        ...
        <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.18em', color: 'rgba(15,21,35,0.72)' }}>NextUs</span>
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '400px', background: '#FFFFFF', border: '1.5px solid rgba(200,146,42,0.78)', borderRadius: '14px', padding: '40px 36px 36px' }}>
        {!sent ? (
          <>
            ...
            <p style={{ ...serif, fontSize: '14px' color: 'rgba(15,21,35,0.72)', marginBottom: '32px', lineHeight: 1.5 }}>Sign in or create your account to continue.</p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0' }}>
              ...
              <span style={{ ...sc, fontSize: '13px', letterSpacing: '0.16em', color: 'rgba(15,21,35,0.72)' }}>or</span>
              <div style={{ flex: 1, height: '1px', background: 'rgba(200,146,42,0.20)' }} />
            </div>
            ...
            {error && <p style={{ ...serif, fontSize: '13px' color: 'rgba(15,21,35,0.78)', marginTop: '8px', padding: '10px 14px', background: 'rgba(200,146,42,0.05)', borderRadius: '14px', border: '1.5px solid rgba(200,146,42,0.35)' }}>{error}</p>}
          </>
        ) : (
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ ...serif, fontSize: '14px' color: 'rgba(15,21,35,0.72)', lineHeight: 1.6 }}>
              We sent a sign-in link to<br />
              <span style={{ fontStyle: 'normal', color: '#A8721A' }}>{email}</span>
            </p>
            <p style={{ ...serif, fontSize: '14px' color: 'rgba(15,21,35,0.72)', marginTop: '12px', lineHeight: 1.6 }}>Click the link to continue. You can close this tab.</p>
          </div>
        )}
      </div>

      <p style={{ marginTop: '32px', ...sc, fontSize: '13px', letterSpacing: '0.14em', color: 'rgba(15,21,35,0.72)' }}>
