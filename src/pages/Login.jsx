...
const inputStyle = { width: '100%', padding: '13px 16px', background: '#FFFFFF', border: '1.5px solid rgba(76,107,69,0.55)', borderRadius: '40px', fontFamily: "'Lora', Georgia, serif", fontSize: '16px', color: '#262420', outline: 'none', marginBottom: '12px', boxSizing: 'border-box' }
...
function GoogleButton() {
  ...
  return (
    <button onClick={handleGoogle} style={{ width: '100%', padding: '13px 16px', background: 'rgba(76,107,69,0.06)', border: '1.5px solid rgba(76,107,69,0.55)', borderRadius: '40px', fontFamily: "'Lora', Georgia, serif", fontSize: '15px', color: '#262420', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
...
export function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#f3f0e9', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
      ...
      {showBack && (
        <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '24px', fontFamily: "'Cormorant SC', Georgia, serif", fontSize: '13px', letterSpacing: '0.14em', color: 'rgba(38,36,32,0.55)', textDecoration: 'none' }}>
