...
export const CIV_DOMAINS = [
  ...
  { slug: 'finance-economy',label: 'Economy',color: '#8C7A3E', colorMuted: 'rgba(140,122,62,0.12)'  },
...
// Slug → CIV_DOMAIN object. Used by PracticeCard, PracticeDetail.
...
// Used by AdminConsole, PracticeContribute, PracticeDetail.
...
// the substrate, not the dimension. Map iterates Object.values(FIELDS).
