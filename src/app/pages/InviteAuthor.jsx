...
const dark  = '#0F1523'
const parch = '#FAFAF7'
const hair  = '1.5px solid rgba(200,146,42,0.22)'
...
const fieldStyle = {
  ...
  border: '1.5px solid rgba(200,146,42,0.4)', background: '#FFFFFF', outline: 'none',
          ...
          <>
                      ...
                      {results.map(r => (
                        <button key={r.id} type="button" onClick={() => { setChosen(r); setResults([]) }}
                          style={{ display: 'flex', alignItems: 'center', gap: '10px', textAlign: 'left',
                            ...
                            border: '1px solid rgba(200,146,42,0.2)', background: '#FAFAF7' }}>
            ...
            <button onClick={generate} disabled={busy}
              style={{ ...sc, fontSize: '14px', letterSpacing: '0.14em', padding: '13px 28px',
                borderRadius: '40px', background: busy ? 'rgba(200,146,42,0.3)' : gold,
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <button onClick={() => { setPhase('compose'); setChosen(null); setAddingNew(false); setNewName(''); setQuery('') }}
                style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em', padding: '12px 24px',
                  ...
                  border: '1px solid rgba(200,146,42,0.3)', color: 'rgba(15,21,35,0.72)', cursor: 'pointer' }}>
                Invite another
              </button>
            </div>
          </>
