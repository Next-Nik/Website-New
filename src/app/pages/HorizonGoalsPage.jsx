    ...
    <div>
      ...
      {actors.length === 0 && calls.length === 0 && (
        <div style={{ textAlign: 'center', padding: '60px 0' }}>
          ...
          <Link to="/atlas" style={{ ...sc, fontSize: '13px', letterSpacing: '0.14em', color: gold, textDecoration: 'none', border: '1px solid rgba(200,146,42,0.5)', borderRadius: '30px', padding: '8px 20px', display: 'inline-block' }}>
            Browse the Atlas →
          </Link>
        </div>
      )}
