...
function PracticeCard({ p, accent }) {
  ...
  return (
    <div style={{ border: '1px solid rgba(200,146,42,0.20)', borderLeft: `3px solid ${accent}`,
          ...
          <div>
            ...
            <textarea value={basis} onChange={e => setBasis(e.target.value)}
              ...
              style={{ ...body, width: '100%', minHeight: '70px', fontSize: '14px', padding: '10px 12px',
                border: '1px solid rgba(200,146,42,0.3)', borderRadius: '8px', marginBottom: '8px', resize: 'vertical' }} />
