...
function PrismTab() {
  const items = [
    ...
    ['Geometry', 'Guided sacred-form tracing with quiet recognition · twenty-three forms, Vesica Piscis to the Icosahedron in the Flower. Pencil-friendly. Candidate onboarding / deepening material.'],
  ]
  return (
