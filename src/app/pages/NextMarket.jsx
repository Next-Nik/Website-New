  ...
  return (
    <button onClick={onClick}
      style={{
        ...
        background: active ? gold : 'rgba(200,146,42,0.06)',
        border: `1px solid ${active ? gold : 'rgba(200,146,42,0.25)'}`,
...
function OfferingCard({ offering, actor }) {
  ...
  return (
    <div style={{
      padding: '22px 24px',
      background: offering.is_flagship ? 'rgba(200,146,42,0.04)' : '#FFFFFF',
      border: offering.is_flagship ? `1.5px solid rgba(200,146,42,0.35)` : '1px solid rgba(200,146,42,0.14)',
      borderRadius: '12px',
      ...
      {offering.url && (
        <a href={offering.url} target="_blank" rel="noopener noreferrer"
          style={{ ...sc, fontSize: '12px', letterSpacing: '0.14em', color: gold,
            ...
            paddingTop: '14px', borderTop: '1px solid rgba(200,146,42,0.18)' }}>
          Learn more →
        </a>
      )}
    </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {loading ? (
            ...
            <div style={{
              ...
              border: '1px solid rgba(200,146,42,0.18)', borderRadius: '14px',
              textAlign: 'center',
            }}>
