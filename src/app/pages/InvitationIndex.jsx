// src/beta/pages/InvitationIndex.jsx
  ...
  return (
    ...
    >
      <div style={{
        padding: '24px 28px',
        background: '#FFFFFF',
        border: '1px solid rgba(76,107,69,0.16)',
        borderLeft: '3px solid rgba(76,107,69,0.55)',
        borderRadius: '12px',
        marginBottom: '14px',
        ...
        onMouseEnter={e => {
          ...
          e.currentTarget.style.boxShadow = '0 2px 12px rgba(76,107,69,0.08)'
        }}
        onMouseLeave={e => {
          e.currentTarget.style.borderLeftColor = 'rgba(76,107,69,0.55)'
        ...
        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginBottom: '12px' }}>
          {domains.map((d, i) => (
            <span key={d} style={{
              ...
              border: `1px solid ${i === 0 ? 'rgba(76,107,69,0.28)' : 'rgba(15,21,35,0.10)'}`,
              borderRadius: '4px',
              padding: '2px 8px',
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '36px' }}>
      <button
        ...
        style={{
          ...
          borderRadius: '40px',
          cursor: 'pointer',
          border: selected === null ? '1.5px solid rgba(76,107,69,0.78)' : '1.5px solid rgba(76,107,69,0.22)',
          background: selected === null ? 'rgba(76,107,69,0.10)' : 'transparent',
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: '40px',
              cursor: 'pointer',
              border: on ? '1.5px solid rgba(76,107,69,0.78)' : '1.5px solid rgba(76,107,69,0.18)',
