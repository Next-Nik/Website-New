    ...
    <div style={{ margin: '4px 0 8px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
        <textarea
          ...
          style={{
            flex: 1, resize: 'none', border: '1px solid rgba(38,36,32,0.28)', borderRadius: '3px',
...
function SectionDivider() {
  return (
    <div style={{
      borderTop: '1px dashed rgba(76,107,69,0.20)',
      margin: '20px 0',
    }} />
  )
}
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: '30px',
              cursor: 'pointer',
              border: `1px solid ${active ? GOLD_LIGHT : 'rgba(76,107,69,0.30)'}`,
