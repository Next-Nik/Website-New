...
// Four-dimensional placement tab for OrgManage.
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      {items.map((item, i) => (
        <div key={item} style={{
          ...
          {i === 0 && (
            <span style={{ ...sc, fontSize: '10px', letterSpacing: '0.16em', background: '#58A08A', color: '#FFFFFF', padding: '2px 8px', borderRadius: '40px', flexShrink: 0 }}>
              Primary
            </span>
          )}
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: '8px' }}>
        ...
        <button onClick={add} disabled={!draft.trim()}
          style={{ ...sc, fontSize: '12px', letterSpacing: '0.12em', padding: '9px 16px', borderRadius: '8px', border: '1.5px solid rgba(88,160,138,0.60)', background: 'rgba(88,160,138,0.05)', color: gold, cursor: 'pointer' }}>
          Add
        </button>
      </div>
