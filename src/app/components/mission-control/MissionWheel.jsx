...
function SelfWheel({
  ...
  const ringStroke  = dark ? 'rgba(100,130,185,0.42)' : 'rgba(76,107,69,0.30)'
  const spokeStroke = dark ? 'rgba(100,130,185,0.60)' : 'rgba(76,107,69,0.42)'
  ...
  return (
    ...
    >
        ...
        <radialGradient id={`mw-well-${dark ? 'dark' : 'light'}`} cx="50%" cy="46%" r="58%">
          {dark ? (
            ...
            <>
              ...
              <stop offset="100%" stopColor="rgba(76,107,69,0.03)" />
            </>
          )}
        </radialGradient>
      ...
      <circle
        ...
        fill="none"
        stroke={dark ? 'rgba(210,222,245,0.10)' : 'rgba(76,107,69,0.10)'}
        strokeWidth="1"
        pointerEvents="none"
      />
      ...
      <g transform={`rotate(${displayRot} ${cx} ${cy})`}>
        ...
        {[0.2, 0.4, 0.5, 0.6, 0.8].map(fr => {
          ...
          return (
            <polygon
              ...
              fill="none"
              stroke={isPass
                ? (dark ? 'rgba(100,130,185,0.34)' : 'rgba(76,107,69,0.32)')
                : (dark ? 'rgba(100,130,185,0.11)' : 'rgba(76,107,69,0.12)')}
        ...
        {Array.from({ length: N }).map((_, i) => {
          ...
          return (
            <g key={`spoke-${i}`}>
              ...
              <circle
                cx={p.x} cy={p.y} r={3}
                fill={dark ? "rgba(100,130,185,0.5)" : "rgba(76,107,69,0.5)"}
                style={{ pointerEvents: 'none' }}
              />
            </g>
          )
        ...
        {showEmpty ? (
          <circle
            cx={cx} cy={cy} r={6}
            fill={dark ? "rgba(100,130,185,0.10)" : "rgba(76,107,69,0.10)"}
            stroke={dark ? "rgba(100,130,185,0.40)" : "rgba(76,107,69,0.40)"}
            strokeWidth="1"
            strokeDasharray="3 3"
            style={{ pointerEvents: 'none' }}
          />
          ...
          <>
            ...
            <polygon
              ...
              fill={dark ? 'rgba(100,130,185,0.14)' : 'rgba(76,107,69,0.10)'}
              stroke={accent}
              strokeWidth="2"
              strokeOpacity="0.85"
              strokeLinejoin="round"
      ...
      {onCentreClick && (
        ...
        >
          ...
          <circle
            cx={cx} cy={cy} r={48}
            fill={dark ? "rgba(100,130,185,0.07)" : "rgba(76,107,69,0.07)"}
          ...
          <circle
            cx={cx} cy={cy} r={28}
            fill={dark ? "rgba(100,130,185,0.15)" : "rgba(76,107,69,0.15)"}
            style={{ opacity: orbTarget, transition: 'opacity 0.4s ease', pointerEvents: 'none' }}
          />
          {/* Tight core — still soft, not solid */}
          <circle
            cx={cx} cy={cy} r={14}
            fill={dark ? "rgba(100,130,185,0.35)" : "rgba(76,107,69,0.35)"}
            stroke={dark ? "rgba(100,130,185,0.5)" : "rgba(76,107,69,0.5)"}
            strokeWidth="1"
            style={{ opacity: orbTarget, transition: 'opacity 0.4s ease', pointerEvents: 'none' }}
          />
          {/* Hit zone */}
      ...
      {offState && (
        <g aria-label="Personal map hidden while acting as another identity" style={{ pointerEvents: 'none' }}>
          ...
          <circle cx={cx} cy={cy} r={24} fill="#FFFFFF" stroke={dark ? "rgba(100,130,185,0.55)" : "rgba(76,107,69,0.55)"} strokeWidth="1.4" />
          {offState.markUrl ? (
            <image
          ...
          <circle cx={cx} cy={cy} r={24} fill="none" stroke={dark ? "rgba(100,130,185,0.30)" : "rgba(76,107,69,0.30)"} strokeWidth="1" />
          {offState.eyebrow && (
            <text
...
function CivWheel({
  ...
  const centreStroke = dark ? 'rgba(100,130,185,0.6)' : 'rgba(76,107,69,0.7)'
    ...
    >
      ...
      {(() => {
        ...
        return (
          <g style={{ opacity: bloomed ? 1 : bloomT }}>
            ...
            <polygon
              points={polyPoints}
              fill={dark ? 'rgba(100,130,185,0.12)' : 'rgba(76,107,69,0.08)'}
              stroke={accent}
              strokeWidth="2"
              strokeOpacity="0.85"
              strokeLinejoin="round"
      ...
      >
        ...
        <circle
          ...
          r={centreRadius + 4}
          fill="none"
          stroke={dark ? "rgba(100,130,185,0.22)" : "rgba(76,107,69,0.22)"}
          strokeWidth="1"
          style={{ pointerEvents: 'none' }}
        >
          <animate
