...
export default function ProfileMissionPanel({ user, onNavigate }) {
  ...
  return (
    <div style={{ padding: '4px 0' }}>
      ...
      {/* Founder: Care Protocol (hidden needs-communication tool). Unlinked
          from all navigation except this button — real enforcement is RLS
          in sql/187_care_protocol.sql, this is just the door. */}
      {isFounder && (
        <button
          onClick={() => onNavigate('/care-protocol')}
          style={{
            display: 'block',
            width: '100%',
            padding: '11px 16px',
      ...
      {/* Founder: Homecoming (the allostasis / set-point tool). Unlinked from all
          navigation except this button — real enforcement is RLS in
          sql/189_homecoming.sql, this is just the door. */}
      {isFounder && (
        <button
          onClick={() => onNavigate('/homecoming')}
          style={{
            display: 'block',
            width: '100%',
            padding: '11px 16px',
