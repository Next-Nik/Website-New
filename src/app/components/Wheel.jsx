...
const GOLD     = '#C8922A'   // chrome / borders
const GOLD_DK  = '#A8721A'   // gold text
const INK      = '#0F1523'
...
export default function Wheel({
  ...
  const spokeCol  = dark ? 'rgba(200,146,42,0.50)'  : 'rgba(200,146,42,0.30)'
  const rimCol    = dark ? 'rgba(200,146,42,0.40)'  : 'rgba(200,146,42,0.32)'
  const ringCol   = dark ? 'rgba(200,146,42,0.16)'  : 'rgba(200,146,42,0.14)'
  const passCol   = dark ? 'rgba(200,146,42,0.42)'  : 'rgba(200,146,42,0.38)'
  const nowHeroStroke = dark ? 'rgba(200,146,42,0.9)' : 'rgba(200,146,42,0.85)'
  const nowHeroFill   = dark ? 'rgba(200,146,42,0.18)' : 'rgba(200,146,42,0.15)'
