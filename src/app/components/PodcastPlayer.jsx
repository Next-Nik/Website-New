...
const hair = 'rgba(200,146,42,0.22)'
  ...
  const Header = (
    <div style={{ display: 'flex', gap: '18px', alignItems: 'center' }}>
      <div style={{
        ...
        boxShadow: `0 0 0 2px ${parch}, 0 0 0 3px rgba(200,146,42,0.3)`,
        overflow: 'hidden',
      }}>
        {show?.image
            ...
            {subscribeLinks.map((l, i) => (
              <a key={i} href={l.url} target="_blank" rel="noopener noreferrer"
                style={{ ...sc, fontSize: '13px', letterSpacing: '0.08em', color: gold,
                  textDecoration: 'none', border: '1px solid rgba(200,146,42,0.5)',
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '6px' }}>
          ...
          <div onClick={seek} style={{ flex: 1, height: '4px', borderRadius: '4px',
            background: 'rgba(200,146,42,0.2)', cursor: 'pointer', position: 'relative' }}>
  ...
  const EpisodeList = (
    <div style={{ marginTop: '20px' }}>
      {visible.map((ep) => {
        ...
        return (
          <div key={ep.guid} style={{ borderBottom: `1px solid rgba(200,146,42,0.15)` }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '15px 0' }}>
              <button onClick={() => playEpisode(ep)} aria-label={isActive && playing ? 'Pause' : 'Play'}
                style={{ flexShrink: 0, width: '36px', height: '36px', borderRadius: '50%',
                  border: `1px solid ${isActive ? 'rgba(200,146,42,0.78)' : 'rgba(200,146,42,0.45)'}`,
                  background: isActive ? 'rgba(200,146,42,0.12)' : parch,
                  display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
