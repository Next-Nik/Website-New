        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', gap: '8px', marginBottom: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {need.medium === 'in_person' && (
              <span style={{ ...sc, fontSize: '11px', letterSpacing: '0.10em', color: gold, background: 'rgba(88,160,138,0.07)', border: '1px solid rgba(88,160,138,0.25)', borderRadius: '4px', padding: '2px 8px' }}>
                In person
              </span>
            )}
            {need.time_estimate && (
