...
export const DOMAIN_COPY = {
  path: {
    ...
    line: 'Your purpose. Your dharma. The work you’re here to do.',
  ...
  spark: {
    ...
    line: 'What lights you up. What fills your tank. Your élan vital.',
  ...
  body: {
    ...
    line: 'Health, fitness, vitality — the vehicle you experience life through.',
  ...
  finances: {
    ...
    line: 'Money and personal power. Your ability to act on what matters.',
  ...
  connection: {
    ...
    line: 'Your relationship with other people — romantic, family, friends, collaborators.',
  ...
  inner_game: {
    ...
    line: 'Your relationship with yourself. Values, beliefs, the story in your head.',
  ...
  signal: {
    ...
    line: 'Your relationship with the world. How you present, and how you’re seen.',
