...
const TESTIMONIALS = [
  ...
  { name: 'A.J.', quote: "I did two rounds of the Horizon Path / Level Up program. Nik is excellent at honing in where you're stuck and creating space for you to see your blind spots. It changed my life." },
  { name: 'A.N.D.', quote: 'Nik helped me uncover an incredible correlation that had been unknowingly holding me back from experiencing true play and embracing all that life has so graciously offered me. I highly recommend Nik to those that are looking to up-level and who desire an accelerated and compassionately guided journey to greatness.' },
  { name: 'J.M.', quote: "At the start of the course I set out my goals, I told Nik what I wanted my life to look like. Two weeks later I came to Nik apologising for not doing my homework — and started telling him I’d met someone and gone on wonderful adventures, my work was expanding. He said ‘Jenn, look at what you wrote down in week one.’ I was already living it." },
  { name: 'N.W.', quote: 'Before I started the program, I was 7/10 of the way to my fitness goals but without knowing it I had serious resistance towards going the rest of the way. Once I started working with Nik, his ability to pull out that one area of resistance made all the difference. It really was life changing.' },
  { name: 'T.H.', quote: 'Highly recommend working with Nik as a coach, and getting to know him as a man. His programme is profound, practical and empowering, and founded on his own high level of authenticity and integrity.' },
  { name: 'E.L.', quote: 'Nik makes you look deeper and ask yourself the questions you rarely explore. He guides you into seeing yourself more clearly and thus you start truly knowing yourself. From this you can make the necessary adjustments to start levelling up your life.' },
  { name: 'S.H.', quote: "Nik's level-up program definitely changed my life. He has the ability to build up the right foundation and the right container to actually be able to be vulnerable and dig deep and go straight to where you need to." },
  { name: 'S.M.A.', quote: 'When that last question hit me, I instantly knew what to do next because I stepped into full being of my highest destiny self — my Horizon self. My self-identity, who I was being, was instantly shifted.' },
  { name: 'D.L.', quote: "One of the things that really helped me was the ability to think about my future self — all the things they knew, all the talents and skills, all the problems they've already solved — and then applying that way of being to my current self." },
  { name: 'T.R.', quote: "Through working with Nik in his program I was able to connect to my Horizon Self. I've always been someone with lofty ambitions but this time I was really able to see a roadmap to the kind of self that I wanted to become and a framework for how to get there." },
  { name: 'E.J.', quote: 'I loved the program. The Horizon Path gave me hope and determination as well as a wider perspective of what is possible.' },
  { name: 'N.H.', quote: "While I went in with a particular intention, in the course I discovered there were other things more important than what I'd originally intended to do. I came away feeling lighter, and more at ease with where I am in life and where I want to go." },
  { name: 'N.M.', quote: "I enjoyed Nik's workshop a lot. I gained clarity about my goals and values in life as well as how to achieve those in an effortless and rather playful way." },
  { name: 'A.', quote: 'I feel forever connected to my level up group. The tools it gave me for expanding my awareness and action to formerly overlooked areas of my life are priceless, absolutely.' },
  { name: 'J.F.', quote: 'I took the Life Athletics level-up coaching program right before I made a really big life change — going from being a raw food entrepreneur to a full-time rapper — and the program really helped me step into that new life really powerfully.' },
  { name: 'Y.R.', quote: "Coming into the program I had many ideas and I didn't know how to actualize them. In this process I learned how to find the tools and what actions I needed to do to move one step at a time." },
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <span style={{ ...sc, fontSize: '15px', letterSpacing: '0.2em', color: '#A8721A', textTransform: 'uppercase', display: 'block', marginBottom: '6px' }}>
                  What people say
                </span>
