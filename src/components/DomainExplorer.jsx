...
// ── TRANSITION TIMING ────────────────────────────────────────────────────────
// Tune these to adjust the feel of the earth → hep wheel crossfade.
// HEP_FADE_IN_DURATION: how long the hep wheel takes to fade in (ms)
// HEP_FADE_IN_DELAY:    how long after onEntered fires before fade starts (ms)
//                       set to 0 for immediate overlap with earth fade-out
const HEP_FADE_IN_DURATION = 1800   // ms
const HEP_FADE_IN_DELAY    = 0      // ms — 0 = blend starts immediately on click
// ─────────────────────────────────────────────────────────────────────────────
