                  ...
                  >
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <span style={{ fontFamily: 'var(--font-sc)', fontSize: '0.6875rem', color: 'rgba(15,21,35,0.72)', minWidth: '18px' }}>
                    ...
                    {isOpen && (
                      <div style={{ padding: '0 18px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.8125rem', color: 'rgba(15,21,35,0.72)', lineHeight: 1.55 }}>
                          {domain.description}
                        </p>
