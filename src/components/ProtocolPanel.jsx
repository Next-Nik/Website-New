                ...
                <div key={phase.number} style={{ position: 'relative' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px', marginBottom: '10px' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px', marginBottom: '3px' }}>
                          <span style={{ fontFamily: "'Cormorant SC', Georgia, serif", fontSize: '1.25rem', color: '#262420', lineHeight: 1.2 }}>
                            {phase.name}
                          </span>
                        ...
                        <div style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.72)', lineHeight: 1.4 }}>
                          {phase.tagline}
                        </div>
                      </div>
                    </div>

                    <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.88)', lineHeight: 1.6, marginBottom: '10px' }}>
                      {phase.description}
                    </p>
                    ...
                    <div style={{ padding: '9px 12px', background: 'rgba(76,107,69,0.06)', borderLeft: '2px solid rgba(76,107,69,0.45)', borderRadius: '0 6px 6px 0' }}>
                      <div style={{ fontFamily: "'Cormorant SC', Georgia, serif", fontSize: '15px', letterSpacing: '0.16em', color: '#262420', textTransform: 'uppercase', marginBottom: '4px' }}>
                        Why this comes here
                      </div>
                      <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: '15px', color: 'rgba(15,21,35,0.88)', lineHeight: 1.55 }}>
                        {phase.why}
                      </p>
                    </div>
                  </div>
