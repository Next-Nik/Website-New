                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px', marginBottom: '10px' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.72)', lineHeight: 1.4 }}>
                          {phase.tagline}
                        </div>
                      </div>
                    </div>

                    <p style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.88)', lineHeight: 1.6, marginBottom: '10px' }}>
                      {phase.description}
                    </p>
