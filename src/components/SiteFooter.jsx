...
export function SiteFooter() {
  return (
    <footer data-site-footer style={{
      borderTop: '1px solid rgba(38,48,42,0.14)',
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '40px', gap: '24px', flexWrap: 'wrap' }}>
          <p style={{ ...bodyFont, fontSize: '15px', color: 'rgba(38,48,42,0.68)' }}>
            A life worth living. A future worth building.
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexShrink: 0 }}>
            <a href="https://www.instagram.com/nikwood.world/" target="_blank" rel="noopener" aria-label="Instagram" style={{ color: 'rgba(38,48,42,0.55)', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
            ...
            <a href="https://www.youtube.com/@NextUs-World" target="_blank" rel="noopener" aria-label="YouTube" style={{ color: 'rgba(38,48,42,0.55)', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ height: '1px', background: 'rgba(38,48,42,0.14)', marginBottom: '28px' }} />
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap', marginBottom: '14px' }}>
          <span style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)' }}>
            {'\u00A9'} 2026 NextUs {'·'} Nik Wood
          </span>
          <div style={{ display: 'flex', gap: '20px' }}>
            <a href="/faq" style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)', textDecoration: 'none' }}>FAQ</a>
            <a href="/support" style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)', textDecoration: 'none' }}>Support Resources</a>
            <a href="mailto:hello@nextus.world" style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)', textDecoration: 'none' }}>Contact</a>
            <a href="/privacy" style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)', textDecoration: 'none' }}>Privacy</a>
            <a href="/terms" style={{ ...mono, fontSize: '15px', letterSpacing: '0.12em', color: 'rgba(38,48,42,0.55)', textDecoration: 'none' }}>Terms</a>
          </div>
        </div>
