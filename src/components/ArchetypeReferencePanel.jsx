                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ color: '#26302A', fontSize: '1.3125rem', transition: 'transform 0.2s', transform: isOpen ? 'rotate(90deg)' : '' }}>
                        →
                      </span>
                    </button>
                    ...
                    {isOpen && (
                      <div style={{ padding: '0 18px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <div style={{ padding: '10px 14px', background: 'rgba(110,127,92,0.06)', borderLeft: '2px solid rgba(110,127,92,0.55)', borderRadius: '0 6px 6px 0' }}>
                          <div style={{ fontFamily: "'IBM Plex Mono', Georgia, serif", fontSize: '15px', letterSpacing: '0.16em', color: '#26302A', textTransform: 'uppercase', marginBottom: '5px' }}>
                            Signal
                          </div>
                          <p style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.88)', lineHeight: 1.6 }}>
                            {archetype.signal}
                          </p>
                        </div>
                        <div style={{ padding: '10px 14px', background: 'rgba(15,21,35,0.72)', borderLeft: '2px solid rgba(15,21,35,0.72)', borderRadius: '0 6px 6px 0' }}>
                          <div style={{ fontFamily: "'IBM Plex Mono', Georgia, serif", fontSize: '15px', letterSpacing: '0.16em', color: 'rgba(15,21,35,0.72)', textTransform: 'uppercase', marginBottom: '5px' }}>
                            Shadow
                          </div>
                          <p style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.72)', lineHeight: 1.6 }}>
                            {archetype.shadow}
