        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <span style={{ ...sc, fontSize: '0.5625rem', letterSpacing: '0.2em', color: 'rgba(200,146,42,0.9)', textTransform: 'uppercase', display: 'block', marginBottom: '4px' }}>
                  Life OS
                </span>
              ...
              {!loading && !sprint && (
                <div style={{ paddingTop: '16px' }}>
                  ...
                  <div style={{ marginTop: '36px', paddingTop: '24px', borderTop: '1px solid rgba(200,146,42,0.12)' }}>
                    <div style={{ ...sc, fontSize: '0.5625rem', letterSpacing: '0.18em', color: 'rgba(200,146,42,0.9)', textTransform: 'uppercase', marginBottom: '12px' }}>
                      How it works
                    </div>
                    {[
              ...
              {!loading && sprint && (
                <>
                        ...
                        {sprint.goals.map((g, i) => {
                          ...
                          return g[key] ? (
                            <div key={i} style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                              <span style={{ ...sc, fontSize: '0.5625rem', color: 'rgba(200,146,42,0.9)', flexShrink: 0, paddingTop: '2px', width: '72px' }}>{dl?.label}</span>
                  ...
                  <div style={{ marginTop: '24px', display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    <a href="/tools/target-sprint" style={{ ...sc, fontSize: '0.75rem', letterSpacing: '0.1em', color: 'rgba(200,146,42,0.9)', border: '1.5px solid rgba(200,146,42,0.78)', borderRadius: '40px', padding: '9px 18px', textDecoration: 'none', background: 'rgba(200,146,42,0.05)' }}>
                      View full sprint {'\u2192'}
                    </a>
          ...
          <button onClick={() => setOpen(false)} style={{
            ...
            <span style={{ ...sc, fontSize: '0.75rem', color: 'rgba(200,146,42,0.9)' }}>{'\u00D7'}</span>
          </button>
        </div>
      )}
