    ...
    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-end', marginTop: '16px' }}>
      <textarea
        ...
        style={{
          ...
          ...serif, fontSize: '16px', fontWeight: 300, ...dark,
    ...
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: 'clamp(88px,10vw,112px) clamp(20px,5vw,40px) 120px' }}>
      ...
      {(step === 'horizon_self' || step === 'skill_suggest' || step === 'skill_confirm') && (
        <GoldCard>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ ...serif, fontSize: '19px', fontWeight: 400, ...dark, marginBottom: '8px' }}>Your Horizon Self</div>
              <p style={{ ...serif, fontSize: '16px', fontWeight: 300, ...muted, lineHeight: 1.7, marginBottom: '16px' }}>
                ...
                <>
                  <textarea
                    ...
                    style={{
                      ...
                      ...serif, fontSize: '16px', fontWeight: 300, ...dark, lineHeight: 1.6,
                      marginBottom: '16px',
                    }}
                  />
                  ...
                  {setupChat.messages.length > 0 && (
                    <>
                      ...
                      <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid rgba(200,146,42,0.15)' }}>
                        <p style={{ ...serif, fontSize: '15px', ...muted, marginBottom: '12px' }}>Happy with this statement?</p>
                        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                          <Btn primary onClick={() => {
      ...
      {(step === 'skill_suggest' || step === 'skill_confirm') && (
        <GoldCard>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ ...serif, fontSize: '19px', fontWeight: 400, ...dark, marginBottom: '8px' }}>Your first skill or knowledge focus</div>
              <p style={{ ...serif, fontSize: '16px', fontWeight: 300, ...muted, lineHeight: 1.7, marginBottom: '16px' }}>
                      ...
                      <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid rgba(200,146,42,0.15)' }}>
                        ...
                        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '12px' }}>
                          <input
                            ...
                            style={{ flex: 1, minWidth: '200px', padding: '12px 16px', borderRadius: '12px', border: '1.5px solid rgba(200,146,42,0.30)', background: '#FAFAF7', outline: 'none', ...serif, fontSize: '16px', ...dark }}
                          />
      ...
      {step === 'done' && firstSkill && horizonSelf && (
        <div style={{ textAlign: 'center', padding: '32px 0' }}>
          ...
          <h3 style={{ ...serif, fontSize: '28px', fontWeight: 300, ...dark, marginBottom: '16px' }}>Your practice is set up.</h3>
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '32px' }}>
        {TEA_STEPS.map(s => (
          <div key={s.key} style={{
            ...
            background: teaData[s.key] ? '#A8721A' : step === s.key ? 'rgba(200,146,42,0.40)' : 'rgba(200,146,42,0.15)',
      ...
      {currentStep && (
        <div style={{ animation: 'fadeIn 0.3s ease' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
            ...
            <span style={{ ...serif, fontSize: '20px', fontWeight: 300, ...dark }}>{currentStep.label}</span>
          </div>
          <p style={{ ...serif, fontSize: '18px', fontWeight: 300, ...dark, lineHeight: 1.75, marginBottom: '24px' }}>
            {currentStep.prompt}
          </p>
          <textarea
            value={response}
            ...
            style={{
              ...
              border: '1.5px solid rgba(200,146,42,0.30)', background: '#FAFAF7',
              resize: 'vertical', outline: 'none', boxSizing: 'border-box',
              ...serif, fontSize: '16px', fontWeight: 300, ...dark, lineHeight: 1.7,
              marginBottom: '16px',
            }}
          />
...
function SkillsList({ skills, onAdd, onUpdate, onTriage, mapData }) {
  ...
  const triageChat = useChat('/tools/expansion/api/setup-chat', { mode: 'triage', mapData })
    ...
    <div>
      ...
      {triageOpen && (
        <GoldCard style={{ marginBottom: '24px' }}>
          ...
          <p style={{ ...serif, fontSize: '15px', fontWeight: 300, ...muted, lineHeight: 1.7, marginBottom: '16px' }}>
...
function LoopJournal({ loops, setupData, onSave }) {
  ...
  const chat = useChat('/tools/expansion/api/loop-chat', { context: { horizonSelf: setupData?.horizonSelf } })
  ...
  return (
    <div>
      ...
      {!active ? (
        <Btn primary onClick={() => { setActive(true); chat.setMessages([{ role: 'assistant', content: "Let's work with a thought loop that's been showing up for you. What's the recurring thought — say it as specifically as you can. Not 'I'm not good enough' but the actual words you hear, the situation that triggers it." }]) }}>
          Work with a loop →
        </Btn>
      ) : (
        <GoldCard>
