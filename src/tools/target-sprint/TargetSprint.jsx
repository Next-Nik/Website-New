  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, background: 'rgba(15,21,35,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', backdropFilter: 'blur(4px)' }}>
      <div style={{ background: '#FAFAF7', border: '1.5px solid rgba(200,146,42,0.78)', borderRadius: '14px', padding: '44px 36px 36px', maxWidth: '460px', width: '100%', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.25rem', color: 'rgba(15,21,35,0.78)', lineHeight: 1.75, marginBottom: '32px' }}>
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, background: 'rgba(15,21,35,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', backdropFilter: 'blur(4px)' }}>
      <div style={{ background: '#FAFAF7', border: '1.5px solid rgba(200,146,42,0.78)', borderRadius: '14px', padding: '40px 32px', maxWidth: '400px', width: '100%', textAlign: 'center' }}>
        ...
        <p style={{ ...body, fontSize: '1.1875rem', ...meta, lineHeight: 1.7, marginBottom: '24px' }}>Sign in and your sprint saves — come back anytime to pick up where you left off.</p>
        ...
        {domains.map(d => {
          ...
          return (
            <div key={d.id} style={{ padding: '14px 0', borderTop: '1px solid rgba(200,146,42,0.1)' }}>
              ...
              {dd.horizonText && (
                <div style={{ ...body, fontSize: '1.125rem', ...muted, lineHeight: 1.6, marginBottom: '6px' }}>
                  Horizon: {dd.horizonText}
                </div>
              )}
...
function ChatPanel({ mode, domainId, payload, onComplete, placeholder, userId }) {
  ...
  async function call(m) {
    ...
    const res = await fetch('/tools/target-sprint/api/chat', {
    ...
    <div>
      ...
      {pendingData && (
        <div style={{ marginBottom: '16px', padding: '16px 18px', background: 'rgba(200,146,42,0.05)', border: '1.5px solid rgba(200,146,42,0.78)', borderRadius: '14px' }}>
          <p style={{ ...body, fontSize: '1.1875rem', color: 'rgba(15,21,35,0.78)', lineHeight: 1.65, marginBottom: '14px' }}>
    ...
    <div>
        ...
        {dd.tasks?.length > 0 && (
          <button
            ...
            style={{
              ...
              background: viewStep === 'coach' ? '#A8721A' : 'rgba(200,146,42,0.08)',
      ...
      {viewStep === 'target_goal' && (
        <div>
          ...
          <p style={{ ...body, fontSize: '1.1875rem', ...muted, lineHeight: 1.7, marginBottom: '4px' }}>
          ...
          {dd.horizonText && (
            <div style={{ ...sc, fontSize: '15px', letterSpacing: '0.14em', ...muted, textTransform: 'uppercase', marginBottom: '14px' }}>
              Toward: <span style={{ ...body, fontSize: '1.125rem', fontStyle: 'italic', textTransform: 'none', letterSpacing: 0, color: 'rgba(15,21,35,0.78)' }}>{dd.horizonText}</span>
            </div>
          )}
          {dd.targetGoal ? (
            <div>
                ...
                {editingDate === milestoneKey ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <input type="date" defaultValue={mDate}
                      style={{ ...body, fontSize: '1rem', color: 'rgba(15,21,35,0.78)', border: '1px solid rgba(200,146,42,0.4)', borderRadius: '6px', padding: '2px 6px', background: '#FAFAF7' }}
              ...
              <div>
                <EditableList
                  ...
                  renderItem={(task, i) => {
                    ...
                    return (
                      <div key={i} style={{ padding: '7px 0', borderTop: i === 0 ? 'none' : '1px solid rgba(200,146,42,0.08)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '24px' }}>
        {[
          ...
          <div key={o.type} onClick={() => select(o.type)}
            style={{ padding: '18px 20px', border: `1.5px solid ${quarterType === o.type ? 'rgba(200,146,42,0.78)' : 'rgba(200,146,42,0.2)'}`, borderRadius: '10px', background: quarterType === o.type ? 'rgba(200,146,42,0.08)' : '#FFFFFF', cursor: 'pointer', transition: 'all 0.2s' }}>
