      ...
      {shown.map(item => {
        ...
        return (
          <button key={item.ref} type="button" onClick={() => toggle(item)} style={{
            ...
            background: added ? 'rgba(76,107,69,0.07)' : 'transparent',
            border: `1px solid ${added ? 'rgba(76,107,69,0.4)' : 'rgba(76,107,69,0.16)'}`,
            ...
            <span style={{
              ...
              border: `1px solid ${added ? tokens.goldChrome : 'rgba(76,107,69,0.35)'}`,
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            border: `1.5px solid ${isDone ? tokens.goldChrome : 'rgba(76,107,69,0.35)'}`,
