// NextSteps — Stage 1 (Arrival) + Phase 2 (Reflection)
// src/tools/nextsteps/stages/ArrivalReflection.jsx
//
  ...
  return (
    <div className={`ns-chat${isFirstLoad ? ' ns-chat--fresh' : ''}`}>
      ...
      <style>{`
        ...
        .ns-input { flex:1; border:1px solid rgba(38,36,32,0.25); border-radius:3px; outline:none; resize:none; font-family:'Lora',Georgia,serif; font-size:1rem; line-height:1.55; color:#0F1523; background:#FFFFFF; padding:10px 12px; min-height:44px; }
        ...
        .ns-send { background:#4c6b45; color:#FFFFFF; border:none; border-radius:3px; padding:10px 20px; font-family:'Cormorant SC',Georgia,serif; font-size:0.8rem; letter-spacing:0.16em; text-transform:uppercase; cursor:pointer; transition:background 0.15s; flex-shrink:0; height:44px; }
