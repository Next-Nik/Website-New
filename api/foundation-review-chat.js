...
const SYSTEM = `You are the Foundation reflection agent for Life OS.
...
export default async function handler(req, res) {
  ...
  try {
    const { period, sessions, previousReviews } = req.body
    ...
    if (!response.ok) {
      ...
      console.error('[foundation-review-chat] API error:', err)
